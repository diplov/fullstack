...
exports.categoryValidationRules = [
    ...
    .isLength({min:3}).withMessage('category name must be at least 3 chearacters')
...
exports.productValudationRule = [
    check('product_name', 'Product name is required').notEmpty()
        .isLength({ min: 3 }).withMessage('Product name must be at least 3 chearacters'),
    ...
    check('product_description', 'Product description is required').notEmpty()
        .isLength({ min: 20 }).withMessage('Product nadescriptionme must be at least 20 chearacters'),
    // check('category', 'Category is required').notEmpty(),
    check('count_in_stock', 'count_in_stock is required').notEmpty()
        .isNumeric().withMessage('count_in_stock must be number'),
